...
function getAssetSrc(src: ComponentProps<"img">["src"]) {
  return typeof src === "string" ? withBasePath(src) : src;
}

export const mdxComponents = {
  MediaContainer,
  img: ({ src, alt = "", ...props }: ComponentProps<"img">) => (
    <img src={getAssetSrc(src)} alt={alt} {...props} />
  ),
  source: ({ src, ...props }: ComponentProps<"source">) => (
    <source src={typeof src === "string" ? withBasePath(src) : src} {...props} />
  ),
